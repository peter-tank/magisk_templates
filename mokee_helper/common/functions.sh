...
priv_perm() {
  ...
  setfattr -x $CON $1 || return 1
}

priv_perm_recursive() {
  find $1 -type d 2>/dev/null | while read dir; do
    priv_perm $dir $2 $3 $4 $6
  done
  find $1 -type f -o -type l 2>/dev/null | while read file; do
    priv_perm $file $2 $3 $5 $6
  done
}
...
append_to_bake_diff() {
  ...
  sort $old | uniq > $TMPDIR/old
  sort $old $new | uniq > $TMPDIR/appendings
  cat $TMPDIR/appendings > $new
  diff -L $old -U0 $TMPDIR/old $new
}

f=v_deleted_sys_app.xml
if [ -f $MODPATH/$f ]; then
  cp_ch $MODPATH/$f /data/system 0600
  ui_print "- Provising Vivo uninstaller settings: /data/system/$f"
  append_to_bake_diff /data/system/$f | while read -r LINE
  do
    ui_print "   $LINE"
  done
  set_perm /data/system/$f 1000 1000 0600 u:object_r:system_data_file:s0
  set_perm $MODPATH/$f 1000 1000 0600 u:object_r:system_data_file:s0
fi
...
[ -d $MODPATH/system/$dir/bin ] && set_perm_recursive $MODPATH/system/$dir/bin 0 2000 0755 0755 u:object_r:system_file:s0
done
[ -f $MODPATH/system/etc/selinux/plat_sepolicy.cil ] && set_perm $MODPATH/system/etc/selinux/plat_sepolicy.cil 0 0 0644 u:object_r:sepolicy_file:s0
[ -f $MODPATH/system/etc/selinux/plat_mac_permissions.xml ] && set_perm $MODPATH/system/etc/selinux/plat_mac_permissions.xml 0 0 0644 u:object_r:mac_perms_file:s0
[ -f $MODPATH/system/system_ext/etc/selinux/system_ext_mac_permissions.xm ] && set_perm $MODPATH/system/system_ext/etc/selinux/system_ext_mac_permissions.xm 0 0 0644 u:object_r:mac_perms_file:s0
if [ -d $MODPATH/system/product ]; then
  set_perm_recursive $MODPATH/system/product 0 0 0755 0644 u:object_r:system_file:s0
  [ -d $MODPATH/system/product/bin ] && set_perm_recursive $MODPATH/system/product/bin 0 0 0755 0755 u:object_r:tmpfs:s0
  [ -d $MODPATH/system/product/overlay ] && set_perm_recursive $MODPATH/system/product/overlay 0 0 0755 0644 u:object_r:vendor_overlay_file:s0
  [ -f $MODPATH/system/product/etc/selinux/product_mac_permissions.xml ] && set_perm $MODPATH/system/vendor/etc/selinux/product_mac_permissions.xml 0 0 0644 u:object_r:mac_perms_file:s0
  for FILE in $(find $MODPATH/system/product -type f -name *".apk"); do
    [ -f x$FILE ] && chcon u:object_r:system_file:s0 $FILE
  done
fi
if [ -d $MODPATH/system/vendor ]; then
  set_perm_recursive $MODPATH/system/vendor 0 0 0755 0644 u:object_r:vendor_file:s0
  [ -d $MODPATH/system/vendor/framework ] && set_perm_recursive $MODPATH/system/vendor/framework 0 0 0644 0755 u:object_r:vendor_framework_file:s0
  [ -f $MODPATH/system/vendor/build.prop ] && set_perm $MODPATH/system/vendor/build.prop 0 0 0600 u:object_r:vendor_file:s0
  [ -d $MODPATH/system/vendor/bin ] && set_perm_recursive $MODPATH/system/vendor/bin 0 2000 0755 0755 u:object_r:vendor_file:s0
  [ -d $MODPATH/system/vendor/app ] && set_perm_recursive $MODPATH/system/vendor/app 0 2000 0755 0644 u:object_r:vendor_app_file:s0
  ...
  [ -d $MODPATH/system/vendor/vgc ] && set_perm_recursive $MODPATH/system/vendor/vgc 0 0 0755 0644 u:object_r:oemfs:s0
  [ -d $MODPATH/system/vendor/vgc/etc ] && set_perm_recursive $MODPATH/system/vendor/vgc/etc 0 0 0755 0644 u:object_r:system_file:s0
  [ -f $MODPATH/system/vendor/vgc/vgc.prop ] && set_perm $MODPATH/system/vendor/vgc/etc/vgc.prop 0 0 0644 u:object_r:system_file:s0
  [ -d $MODPATH/system/vendor/etc ] && set_perm_recursive $MODPATH/system/vendor/etc 0 0 0755 0644 u:object_r:vendor_configs_file:s0
  [ -d $MODPATH/system/vendor/etc ] && set_perm $MODPATH/system/vendor/etc 0 2000 0755 u:object_r:vendor_configs_file:s0
  [ -d $MODPATH/system/vendor/etc/selinux ] && set_perm $MODPATH/system/vendor/etc/selinux 0 2000 0755 u:object_r:vendor_configs_file:s0
  for FILE in $(find $MODPATH/system/vendor -type f -name *".apk"); do
    [ -f $FILE ] && chcon u:object_r:vendor_app_file:s0 $FILE
  done
fi
for FILE in $(find $MODPATH/apex -type f -name *".so"); do
  [ -f $FILE ] && chcon u:object_r:system_lib_file:s0 $FILE
done
set_permissions
